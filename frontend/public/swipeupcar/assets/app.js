...
function renderFooter(){
  ...
  el.innerHTML=`<footer style="background:var(--carbon);color:#EDE6DA;margin-top:60px">
   <div class="container" style="padding:50px 20px;display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:30px">
    ...
    <div><h4 class="fh">Informations</h4><a href="infos.html#how" class="foot">Comment ça marche</a><a href="infos.html#security" class="foot">Sécurité</a><a href="infos.html#faq" class="foot">FAQ</a><a href="cgu.html" class="foot">CGU</a><a href="cgv.html" class="foot">CGV</a><a href="confidentialite.html" class="foot">Confidentialité</a></div>
