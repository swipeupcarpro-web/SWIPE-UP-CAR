...
function renderFooter(){
  ...
  el.innerHTML=`<footer style="background:var(--carbon);color:#EDE6DA;margin-top:60px">
   <div class="container" style="padding:50px 20px;display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:30px">
    ...
    <div><h4 class="fh">Informations</h4><a href="infos.html#how" class="foot">Comment ça marche</a><a href="infos.html#security" class="foot">Sécurité</a><a href="infos.html#faq" class="foot">FAQ</a><a href="cgu.html" class="foot">CGU</a><a href="cgv.html" class="foot">CGV</a><a href="confidentialite.html" class="foot">Confidentialité</a><a href="mentions-legales.html" class="foot">Mentions légales</a></div>
   ...
   <div style="border-top:1px solid #33302b"><div class="container" style="padding:18px 20px;display:flex;flex-wrap:wrap;gap:10px;justify-content:space-between;color:#8a8175;font-size:13px"><span>© 2026 SWIPEUPCAR — Plateforme de mise en relation.</span><a href="mentions-legales.html" style="color:#8a8175">Mentions légales</a></div></div>
  </footer>
